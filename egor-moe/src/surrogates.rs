...
use egor_gp::{correlation_models::*, mean_models::*, GaussianProcess, GpParams, GpValidParams};
...
pub trait GpSurrogate: std::fmt::Display + std::fmt::Debug {
    fn predict_values(&self, x: &ArrayView2<f64>) -> egor_gp::Result<Array2<f64>>;
    fn predict_variances(&self, x: &ArrayView2<f64>) -> egor_gp::Result<Array2<f64>>;
