...
use argmin::core::{CostFunction, Problem, Solver, State, TerminationReason, KV};
...
where
    O: CostFunction<Param = Array1<f64>, Output = Array1<f64>> + GroupFunc,
    ...
    SB: SurrogateBuilder + Serialize,
{
    ...
    fn eval<O: CostFunction<Param = Array1<f64>, Output = Array1<f64>> + GroupFunc>(
        &self,
        pb: &mut Problem<O>,
        x: &Array2<f64>,
    ) -> Array2<f64> {
