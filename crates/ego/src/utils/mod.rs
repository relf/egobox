...
/// Env variable to enable the use of the middle-picker multistarter method for global infill criterion optimization
pub const EGOR_USE_MIDDLEPICKER_MULTISTARTER: &str = "EGOR_USE_MIDDLEPICKER_MULTISTARTER";
