...
```text
[dependencies]
egobox-doe = { version = "0.34" }
egobox-gp  = { version = "0.34" }
egobox-moe = { version = "0.34" }
egobox-ego = { version = "0.34" }
```
...
```text
[dependencies]
egobox-gp = { version = "0.34", features = ["blas", "linfa/intel-mkl-static"] }
```
