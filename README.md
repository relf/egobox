...
```text
[dependencies]
egobox-doe = { version = "0.29" }
egobox-gp  = { version = "0.29" }
egobox-moe = { version = "0.29" }
egobox-ego = { version = "0.29" }
```
...
```text
[dependencies]
egobox-gp = { version = "0.29", features = ["blas", "linfa/intel-mkl-static"] }
```
